...
libs_softmmu=-lpixman-1 -lutil   -lseccomp -L$(BUILD_DIR)/dtc/libfdt -lfdt
ARCH=x86_64
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.10.0
PKGVERSION=
SRC_PATH=/home/khoile/uafuzz/binsec/src/uafuzz/afl-2.52b/qemu_mode_uafuzz/qemu-2.10.0
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/khoile/uafuzz/binsec/src/uafuzz/afl-2.52b/qemu_mode_uafuzz/qemu-2.10.0/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/accel/tcg -I$(SRC_PATH)/include
AUTOCONF_HOST := 
