...
# 664 "parser/parser_infos.ml"
                ...
                ((let ((((_menhir_stack, _menhir_s), _, (e : 'tv_expr)), (x00 : 'tv_endianness)), (bytes : (
# 231 "parser/parser_infos.mly"
       (string)
...
# 165 "/home/khoile/.opam/4.05.0/lib/menhir/standard.mly"
    ( x )
# 685 "parser/parser_infos.ml"
                    
                  in
                  
# 112 "/home/khoile/.opam/4.05.0/lib/menhir/standard.mly"
    ( Some x )
# 691 "parser/parser_infos.ml"
                  
                in
                
# 450 "parser/parser_infos.mly"
                       (
...
and _menhir_goto_lhslist : _menhir_env -> 'ttv_tail -> _menhir_state -> 'tv_lhslist -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState153 ->
        ...
        let _2 = () in
        let _v : 'tv_lhslist = 
# 421 "parser/parser_infos.mly"
                     ( _1 :: _3 )
# 918 "parser/parser_infos.ml"
         in
...
# 950 "parser/parser_infos.ml"
    ...
    | MenhirState127 ->
        ...
        let _2 = () in
        let _v : 'tv_printargs = 
# 431 "parser/parser_infos.mly"
                           ( (Exp _1) :: _3 )
# 963 "parser/parser_infos.ml"
         in
...
# 234 "parser/parser_infos.mly"
       (string * int)
# 1040 "parser/parser_infos.ml"
                ))) = _menhir_stack in
                let _5 = () in
                let _3 = () in
                let _1 = () in
                let _v : 'tv_expr = 
# 487 "parser/parser_infos.mly"
                                       (
   let s, size = _4 in
...
# 231 "parser/parser_infos.mly"
       (string)
# 1110 "parser/parser_infos.ml"
                        ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 1114 "parser/parser_infos.ml"
                        )) = Obj.magic _menhir_stack in
                        ((let _menhir_env = _menhir_discard _menhir_env in
                        let _tok = _menhir_env._menhir_token in
                        match _tok with
...
# 231 "parser/parser_infos.mly"
       (string)
# 1124 "parser/parser_infos.ml"
                            ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 1128 "parser/parser_infos.ml"
                            ))) = Obj.magic _menhir_stack in
                            ((let _menhir_env = _menhir_discard _menhir_env in
                            let (_menhir_env : _menhir_env) = _menhir_env in
...
# 231 "parser/parser_infos.mly"
       (string)
# 1144 "parser/parser_infos.ml"
                            ))), (_6 : (
# 231 "parser/parser_infos.mly"
       (string)
# 1148 "parser/parser_infos.ml"
                            ))) = _menhir_stack in
                            let _8 = () in
                            let _7 = () in
                            let _5 = () in
...
# 231 "parser/parser_infos.mly"
       (string)
# 1173 "parser/parser_infos.ml"
                            ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 1177 "parser/parser_infos.ml"
                            ))) = Obj.magic _menhir_stack in
                            ((let (((_menhir_stack, _menhir_s, _), _), _) = _menhir_stack in
...
# 231 "parser/parser_infos.mly"
       (string)
# 1188 "parser/parser_infos.ml"
                        ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 1192 "parser/parser_infos.ml"
                        )) = Obj.magic _menhir_stack in
                        ((let (((_menhir_stack, _menhir_s, _), _), _) = _menhir_stack in
...
# 231 "parser/parser_infos.mly"
       (string)
# 1257 "parser/parser_infos.ml"
            )) : (
# 231 "parser/parser_infos.mly"
       (string)
# 1261 "parser/parser_infos.ml"
            )) = _v in
...
# 231 "parser/parser_infos.mly"
       (string)
# 1298 "parser/parser_infos.ml"
            )) : (
# 231 "parser/parser_infos.mly"
       (string)
# 1302 "parser/parser_infos.ml"
            )) = _v in
            ((let ((_menhir_stack, _menhir_s), _, (_2 : 'tv_expr)) = _menhir_stack in
            let _1 = () in
            let _v : 'tv_expr = 
...
# 231 "parser/parser_infos.mly"
       (string)
# 1461 "parser/parser_infos.ml"
                            ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 1465 "parser/parser_infos.ml"
                            )) = Obj.magic _menhir_stack in
                            ((let _menhir_env = _menhir_discard _menhir_env in
                            let (_menhir_env : _menhir_env) = _menhir_env in
...
# 231 "parser/parser_infos.mly"
       (string)
# 1481 "parser/parser_infos.ml"
                            ))), (_6 : (
# 231 "parser/parser_infos.mly"
       (string)
# 1485 "parser/parser_infos.ml"
                            ))) = _menhir_stack in
                            let _7 = () in
                            let _5 = () in
                            let _3 = () in
...
# 231 "parser/parser_infos.mly"
       (string)
# 1508 "parser/parser_infos.ml"
                            ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 1512 "parser/parser_infos.ml"
                            )) = Obj.magic _menhir_stack in
                            ((let (((_menhir_stack, _menhir_s, _), _), _) = _menhir_stack in
...
# 1869 "parser/parser_infos.ml"
        ...
        | RROTATE ->
            ...
            ((let _1 = () in
            let _v : 'tv_bin_op = 
# 554 "parser/parser_infos.mly"
            ( Dba.Binary_op.RightRotate )
# 1882 "parser/parser_infos.ml"
             in
...
# 1921 "parser/parser_infos.ml"
    ...
    | MenhirState88 ->
        ...
        | RPAR ->
            ...
            let _1 = () in
            let _v : 'tv_expr = 
# 524 "parser/parser_infos.mly"
                              ( Dba.Expr.binary _3 _2 _4 )
# 1949 "parser/parser_infos.ml"
             in
    ...
    | MenhirState91 ->
        ...
        let _1 = () in
        let _v : 'tv_expr = 
# 513 "parser/parser_infos.mly"
                 ( Dba.Expr.lognot _2 )
# 1999 "parser/parser_infos.ml"
         in
...
# 2055 "parser/parser_infos.ml"
                            ...
                            let _1 = () in
                            let _v : 'tv_expr = 
# 498 "parser/parser_infos.mly"
                                                          (
   let size = int_of_string _7 |> Size.Byte.create in
   Dba.Expr.load size BigEndian _3
 )
# 2069 "parser/parser_infos.ml"
                             in
...
# 2138 "parser/parser_infos.ml"
                            ...
                            let _1 = () in
                            let _v : 'tv_expr = 
# 502 "parser/parser_infos.mly"
                                                             (
   let size = int_of_string _7 |> Size.Byte.create in
   Dba.Expr.load size LittleEndian _3
 )
# 2152 "parser/parser_infos.ml"
                             in
...
# 461 "parser/parser_infos.mly"
             ( Dba.BigEndian )
# 2272 "parser/parser_infos.ml"
                 in
...
# 2413 "parser/parser_infos.ml"
    ...
    | MenhirState204 | MenhirState199 | MenhirState173 | MenhirState145 ->
        ...
        let _v : 'tv_cond = 
# 564 "parser/parser_infos.mly"
           ( e )
# 2432 "parser/parser_infos.ml"
         in
    ...
    | MenhirState194 ->
        ...
        | RPAR ->
            ...
            | SEMICOLON ->
                ...
                let _1 = () in
                let _v : 'tv_inst = 
# 393 "parser/parser_infos.mly"
                                 ( Free (_3, 0) )
# 2541 "parser/parser_infos.ml"
                 in
...
# 2588 "parser/parser_infos.ml"
    ...
    | MenhirState209 ->
        ...
        | SEMICOLON ->
            ...
            let _2 = () in
            let _v : 'tv_inst = 
# 387 "parser/parser_infos.mly"
                             ( Assign (_1, _3, 0) )
# 2623 "parser/parser_infos.ml"
             in
...
# 232 "parser/parser_infos.mly"
       (string)
# 2738 "parser/parser_infos.ml"
                            )))) = Obj.magic _menhir_stack in
                            let (_v : (
# 232 "parser/parser_infos.mly"
       (string)
# 2743 "parser/parser_infos.ml"
                            )) = _v in
                            ((let _menhir_stack = (_menhir_stack, _v) in
                            let _menhir_env = _menhir_discard _menhir_env in
                            let _tok = _menhir_env._menhir_token in
...
# 232 "parser/parser_infos.mly"
       (string)
# 2765 "parser/parser_infos.ml"
                                )))) * (
# 232 "parser/parser_infos.mly"
       (string)
# 2769 "parser/parser_infos.ml"
                                )) = Obj.magic _menhir_stack in
                                ((let ((((_menhir_stack, _menhir_s), _, (_2 : 'tv_cond)), _, (_4 : (
# 232 "parser/parser_infos.mly"
       (string)
# 2774 "parser/parser_infos.ml"
                                ))), (_7 : (
# 232 "parser/parser_infos.mly"
       (string)
# 2778 "parser/parser_infos.ml"
                                ))) = _menhir_stack in
                                let _8 = () in
                                let _6 = () in
                                let _5 = () in
                                ...
                                let _1 = () in
                                let _v : 'tv_inst = 
# 408 "parser/parser_infos.mly"
                                                     (
   If (_2, (Label _4), (LabelIf _7))
 )
# 2790 "parser/parser_infos.ml"
                                 in
...
# 232 "parser/parser_infos.mly"
       (string)
# 2800 "parser/parser_infos.ml"
                                )))) * (
# 232 "parser/parser_infos.mly"
       (string)
# 2804 "parser/parser_infos.ml"
                                )) = Obj.magic _menhir_stack in
                                ((let ((_menhir_stack, _menhir_s, _), _) = _menhir_stack in
...
# 231 "parser/parser_infos.mly"
       (string)
# 2879 "parser/parser_infos.ml"
                            )))) = Obj.magic _menhir_stack in
                            let (_v : (
# 231 "parser/parser_infos.mly"
       (string)
# 2884 "parser/parser_infos.ml"
                            )) = _v in
                            ((let _menhir_stack = (_menhir_stack, _v) in
                            let _menhir_env = _menhir_discard _menhir_env in
                            let _tok = _menhir_env._menhir_token in
...
# 231 "parser/parser_infos.mly"
       (string)
# 2906 "parser/parser_infos.ml"
                                )))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 2910 "parser/parser_infos.ml"
                                )) = Obj.magic _menhir_stack in
                                ((let ((((_menhir_stack, _menhir_s), _, (_2 : 'tv_cond)), _, (_4 : (
# 231 "parser/parser_infos.mly"
       (string)
# 2915 "parser/parser_infos.ml"
                                ))), (_7 : (
# 231 "parser/parser_infos.mly"
       (string)
# 2919 "parser/parser_infos.ml"
                                ))) = _menhir_stack in
                                let _8 = () in
                                let _6 = () in
                                let _5 = () in
...
# 231 "parser/parser_infos.mly"
       (string)
# 2941 "parser/parser_infos.ml"
                                )))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 2945 "parser/parser_infos.ml"
                                )) = Obj.magic _menhir_stack in
                                ((let ((_menhir_stack, _menhir_s, _), _) = _menhir_stack in
...
# 425 "parser/parser_infos.mly"
            ( `Constant )
# 3348 "parser/parser_infos.ml"
                         in
...
# 233 "parser/parser_infos.mly"
       (string)
# 3491 "parser/parser_infos.ml"
        )) = Obj.magic _menhir_stack in
        ((let (_menhir_stack, _menhir_s, (_1 : (
# 233 "parser/parser_infos.mly"
       (string)
# 3496 "parser/parser_infos.ml"
        ))) = _menhir_stack in
        let _v : 'tv_printargs = 
# 434 "parser/parser_infos.mly"
                           ( [Str _1] )
# 3501 "parser/parser_infos.ml"
         in
...
# 231 "parser/parser_infos.mly"
       (string)
# 3530 "parser/parser_infos.ml"
        ))) = Obj.magic _menhir_stack in
        let (_v : (
# 231 "parser/parser_infos.mly"
       (string)
# 3535 "parser/parser_infos.ml"
        )) = _v in
        ((let _menhir_stack = (_menhir_stack, _v) in
        let _menhir_env = _menhir_discard _menhir_env in
        let _tok = _menhir_env._menhir_token in
...
# 231 "parser/parser_infos.mly"
       (string)
# 3557 "parser/parser_infos.ml"
            ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 3561 "parser/parser_infos.ml"
            )) = Obj.magic _menhir_stack in
            ((let ((_menhir_stack, _menhir_s, (_1 : (
# 231 "parser/parser_infos.mly"
       (string)
# 3566 "parser/parser_infos.ml"
            ))), (_3 : (
# 231 "parser/parser_infos.mly"
       (string)
# 3570 "parser/parser_infos.ml"
            ))) = _menhir_stack in
            let _4 = () in
            let _2 = () in
            let _v : 'tv_expr = 
# 466 "parser/parser_infos.mly"
                       (
...
# 231 "parser/parser_infos.mly"
       (string)
# 3592 "parser/parser_infos.ml"
            ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 3596 "parser/parser_infos.ml"
            )) = Obj.magic _menhir_stack in
            ((let ((_menhir_stack, _menhir_s, _), _) = _menhir_stack in
...
# 3719 "parser/parser_infos.ml"
    ...
    | STACK ->
        ...
        ((let _1 = () in
        let _v : 'tv_region = 
# 558 "parser/parser_infos.mly"
            ( `Stack )
# 3752 "parser/parser_infos.ml"
         in
...
# 232 "parser/parser_infos.mly"
       (string)
# 3861 "parser/parser_infos.ml"
    )) : (
# 232 "parser/parser_infos.mly"
       (string)
# 3865 "parser/parser_infos.ml"
    )) = _v in
    ((let _v : 'tv_expr = 
# 494 "parser/parser_infos.mly"
         (
   Dba.Expr.var _1 32 None
 )
# 3872 "parser/parser_infos.ml"
     in
...
# 234 "parser/parser_infos.mly"
       (string * int)
# 3889 "parser/parser_infos.ml"
    )) : (
# 234 "parser/parser_infos.mly"
       (string * int)
# 3893 "parser/parser_infos.ml"
    )) = _v in
    ((let _v : 'tv_expr = 
# 473 "parser/parser_infos.mly"
        (
   let s, size = _1 in
   let bigint = (Bigint.big_int_of_string s) in
   let bv = Bitvector.create bigint size in
...
# 231 "parser/parser_infos.mly"
       (string)
# 4014 "parser/parser_infos.ml"
        )) = Obj.magic _menhir_stack in
        ((let (_menhir_stack, _menhir_s, (x : (
# 231 "parser/parser_infos.mly"
       (string)
# 4019 "parser/parser_infos.ml"
        ))) = _menhir_stack in
        let _v : 'tv_separated_nonempty_list_COMMA_INT_ = 
# 215 "/home/khoile/.opam/4.05.0/lib/menhir/standard.mly"
    ( [ x ] )
# 4024 "parser/parser_infos.ml"
         in
...
# 232 "parser/parser_infos.mly"
       (string)
# 4270 "parser/parser_infos.ml"
        ))) = Obj.magic _menhir_stack in
        let (_v : (
# 231 "parser/parser_infos.mly"
       (string)
# 4275 "parser/parser_infos.ml"
        )) = _v in
        ((let _menhir_stack = (_menhir_stack, _v) in
        let _menhir_env = _menhir_discard _menhir_env in
        let _tok = _menhir_env._menhir_token in
...
# 232 "parser/parser_infos.mly"
       (string)
# 4286 "parser/parser_infos.ml"
            ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4290 "parser/parser_infos.ml"
            )) = Obj.magic _menhir_stack in
            ((let _menhir_env = _menhir_discard _menhir_env in
            let _tok = _menhir_env._menhir_token in
            match _tok with
...
# 232 "parser/parser_infos.mly"
       (string)
# 4300 "parser/parser_infos.ml"
                ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4304 "parser/parser_infos.ml"
                ))) = Obj.magic _menhir_stack in
                ((let _menhir_env = _menhir_discard _menhir_env in
                let _tok = _menhir_env._menhir_token in
                match _tok with
...
# 231 "parser/parser_infos.mly"
       (string)
# 4318 "parser/parser_infos.ml"
                    )))) = Obj.magic _menhir_stack in
                    let (_v : (
# 231 "parser/parser_infos.mly"
       (string)
# 4323 "parser/parser_infos.ml"
                    )) = _v in
                    ((let _menhir_stack = (_menhir_stack, _v) in
                    let _menhir_env = _menhir_discard _menhir_env in
                    let _tok = _menhir_env._menhir_token in
...
# 232 "parser/parser_infos.mly"
       (string)
# 4334 "parser/parser_infos.ml"
                        ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4338 "parser/parser_infos.ml"
                        )))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4342 "parser/parser_infos.ml"
                        )) = Obj.magic _menhir_stack in
                        ((let _menhir_env = _menhir_discard _menhir_env in
                        let _tok = _menhir_env._menhir_token in
                        match _tok with
...
# 231 "parser/parser_infos.mly"
       (string)
# 4360 "parser/parser_infos.ml"
                            ))) = Obj.magic _menhir_stack in
                            let (_v : (
# 231 "parser/parser_infos.mly"
       (string)
# 4365 "parser/parser_infos.ml"
                            )) = _v in
                            ((let _menhir_stack = (_menhir_stack, _v) in
                            let _menhir_env = _menhir_discard _menhir_env in
                            let _tok = _menhir_env._menhir_token in
...
# 232 "parser/parser_infos.mly"
       (string)
# 4376 "parser/parser_infos.ml"
                                ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4380 "parser/parser_infos.ml"
                                )))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4384 "parser/parser_infos.ml"
                                ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4388 "parser/parser_infos.ml"
                                )) = Obj.magic _menhir_stack in
                                ((let _menhir_env = _menhir_discard _menhir_env in
                                let (_menhir_env : _menhir_env) = _menhir_env in
...
# 232 "parser/parser_infos.mly"
       (string)
# 4395 "parser/parser_infos.ml"
                                ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4399 "parser/parser_infos.ml"
                                )))) * (
# 231 "parser/parser_infos.mly"
       (string)
...
# 232 "parser/parser_infos.mly"
       (string)
# 4412 "parser/parser_infos.ml"
                                ))), (sz : (
# 231 "parser/parser_infos.mly"
       (string)
# 4416 "parser/parser_infos.ml"
                                ))), (lo : (
# 231 "parser/parser_infos.mly"
       (string)
# 4420 "parser/parser_infos.ml"
                                ))), (hi : (
# 231 "parser/parser_infos.mly"
       (string)
# 4424 "parser/parser_infos.ml"
                                ))) = _menhir_stack in
                                let _9 = () in
                                let _7 = () in
                                let _5 = () in
...
# 232 "parser/parser_infos.mly"
       (string)
# 4449 "parser/parser_infos.ml"
                                ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4453 "parser/parser_infos.ml"
                                )))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4457 "parser/parser_infos.ml"
                                ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4461 "parser/parser_infos.ml"
                                )) = Obj.magic _menhir_stack in
...
# 232 "parser/parser_infos.mly"
       (string)
# 4472 "parser/parser_infos.ml"
                            ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4476 "parser/parser_infos.ml"
                            )))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4480 "parser/parser_infos.ml"
                            ))) = Obj.magic _menhir_stack in
                            ((let (((_menhir_stack, _menhir_s, _), _), _) = _menhir_stack in
...
# 232 "parser/parser_infos.mly"
       (string)
# 4491 "parser/parser_infos.ml"
                        ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4495 "parser/parser_infos.ml"
                        )))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4499 "parser/parser_infos.ml"
                        )) = Obj.magic _menhir_stack in
                        ((let (((_menhir_stack, _menhir_s, _), _), _) = _menhir_stack in
...
# 232 "parser/parser_infos.mly"
       (string)
# 4555 "parser/parser_infos.ml"
                ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4559 "parser/parser_infos.ml"
                ))) = Obj.magic _menhir_stack in
                ((let ((_menhir_stack, _menhir_s, _), _) = _menhir_stack in
...
# 232 "parser/parser_infos.mly"
       (string)
# 4570 "parser/parser_infos.ml"
            ))) * (
# 231 "parser/parser_infos.mly"
       (string)
# 4574 "parser/parser_infos.ml"
            )) = Obj.magic _menhir_stack in
            ((let ((_menhir_stack, _menhir_s, _), _) = _menhir_stack in
...
# 4674 "parser/parser_infos.ml"
    ...
    | STATE_OK ->
        ...
        | SEMICOLON ->
            ...
            let _1 = () in
            let _v : 'tv_inst = 
# 411 "parser/parser_infos.mly"
                           ( Stop (Some OK) )
# 4703 "parser/parser_infos.ml"
             in
...
# 231 "parser/parser_infos.mly"
       (string)
# 4840 "parser/parser_infos.ml"
            )) = Obj.magic _menhir_stack in
            ((let ((_menhir_stack, _menhir_s), _, (_2 : (
# 231 "parser/parser_infos.mly"
       (string)
# 4845 "parser/parser_infos.ml"
            ))) = _menhir_stack in
            let _3 = () in
            let _1 = () in
            let _v : 'tv_inst = 
...
# 232 "parser/parser_infos.mly"
       (string)
# 4909 "parser/parser_infos.ml"
            )) = Obj.magic _menhir_stack in
            ((let ((_menhir_stack, _menhir_s), (_2 : (
# 232 "parser/parser_infos.mly"
       (string)
# 4914 "parser/parser_infos.ml"
            ))) = _menhir_stack in
            let _3 = () in
            let _1 = () in
            let _v : 'tv_inst = 
...
and _menhir_goto_loption_separated_nonempty_list_SEMICOLON_address__ : _menhir_env -> 'ttv_tail -> _menhir_state -> 'tv_loption_separated_nonempty_list_SEMICOLON_address__ -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    let (_menhir_s : _menhir_state) = _menhir_s in
    let ((xs0 : 'tv_loption_separated_nonempty_list_SEMICOLON_address__) : 'tv_loption_separated_nonempty_list_SEMICOLON_address__) = _v in
    ((let _v : 'tv_addresses = let addr =
      let xs = xs0 in
      
# 206 "/home/khoile/.opam/4.05.0/lib/menhir/standard.mly"
    ( xs )
# 5261 "parser/parser_infos.ml"
      
    in
    
# 307 "parser/parser_infos.mly"
                                            ( addr )
# 5267 "parser/parser_infos.ml"
     in
    let (_menhir_env : _menhir_env) = _menhir_env in
...
and _menhir_goto_list_delimited_LPAR_separated_pair_address_COMMA_address__RPAR__ : _menhir_env -> 'ttv_tail -> _menhir_state -> 'tv_list_delimited_LPAR_separated_pair_address_COMMA_address__RPAR__ -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState275 ->
        ...
        ((let (((_menhir_stack, _menhir_s), _, (x00 : 'tv_address)), _, (y00 : 'tv_address)) = _menhir_stack in
        let _30 = () in
        let _200 = () in
        let _10 = () in
...
# 149 "/home/khoile/.opam/4.05.0/lib/menhir/standard.mly"
    ( (x, y) )
# 5463 "parser/parser_infos.ml"
            
          in
          
# 174 "/home/khoile/.opam/4.05.0/lib/menhir/standard.mly"
    ( x )
# 5469 "parser/parser_infos.ml"
          
        in
        
# 187 "/home/khoile/.opam/4.05.0/lib/menhir/standard.mly"
    ( x :: xs )
# 5475 "parser/parser_infos.ml"
         in
...
# 5721 "parser/parser_infos.ml"
    ...
    | MenhirState17 ->
        ...
        let _v : 'tv_insts = 
# 364 "parser/parser_infos.mly"
              (
   index := !index + 1;
   _1 @ [_2]
 )
# 5740 "parser/parser_infos.ml"
         in
...
# 232 "parser/parser_infos.mly"
       (string)
# 5785 "parser/parser_infos.ml"
            )) = Obj.magic _menhir_stack in
            ((let (_menhir_stack, _menhir_s, (_1 : (
# 232 "parser/parser_infos.mly"
       (string)
# 5790 "parser/parser_infos.ml"
            ))) = _menhir_stack in
            let _2 = () in
            let _v : 'tv_label = 
# 384 "parser/parser_infos.mly"
               ( _1 )
# 5796 "parser/parser_infos.ml"
             in
            let (_menhir_env : _menhir_env) = _menhir_env in
...
# 237 "parser/parser_infos.mly"
      (Infos.t)
# 6159 "parser/parser_infos.ml"
        ) = 
# 244 "parser/parser_infos.mly"
         ( _1 )
# 6163 "parser/parser_infos.ml"
         in
        let (_menhir_env : _menhir_env) = _menhir_env in
...
# 237 "parser/parser_infos.mly"
      (Infos.t)
# 6187 "parser/parser_infos.ml"
        )) : (
# 237 "parser/parser_infos.mly"
      (Infos.t)
# 6191 "parser/parser_infos.ml"
        )) = _v in
...
# 235 "parser/parser_infos.mly"
       (string * int)
# 6241 "parser/parser_infos.ml"
    )) : (
# 235 "parser/parser_infos.mly"
       (string * int)
# 6245 "parser/parser_infos.ml"
    )) = _v in
    ((let _v : 'tv_address = 
...
# 6289 "parser/parser_infos.ml"
    ...
    | MenhirState301 | MenhirState11 | MenhirState13 ->
        ...
        | LBRACE ->
            ...
            ((let _v : 'tv_insts = 
# 378 "parser/parser_infos.mly"
   (  reset_label_map;
      index := 0;
      []
   )
# 6317 "parser/parser_infos.ml"
             in
...
# 231 "parser/parser_infos.mly"
       (string)
# 6578 "parser/parser_infos.ml"
                    )) = Obj.magic _menhir_stack in
                    ((let ((_menhir_stack, _menhir_s, (_1 : 'tv_address)), (_3 : (
# 231 "parser/parser_infos.mly"
       (string)
# 6583 "parser/parser_infos.ml"
                    ))) = _menhir_stack in
                    let _2 = () in
                    let _v : 'tv_local_delays = 
...
# 231 "parser/parser_infos.mly"
       (string)
# 7284 "parser/parser_infos.ml"
            )) : (
# 231 "parser/parser_infos.mly"
       (string)
# 7288 "parser/parser_infos.ml"
            )) = _v in
            ((let (_menhir_stack, _menhir_s) = _menhir_stack in
            let _2 = () in
            let _1 = () in
