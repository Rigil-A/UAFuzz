...
# 549 "parser/SMTParserWp.ml"
        ...
        ((let ((_menhir_stack, _menhir_s), _, (x0 : 'tv_args)) = _menhir_stack in
        let _30 = () in
        let _10 = () in
        let _v : (
# 28 "parser/SMTParserWp.mly"
...
# 174 "/home/khoile/.opam/4.05.0/lib/menhir/standard.mly"
    ( x )
# 565 "parser/SMTParserWp.ml"
          
        in
        
# 39 "parser/SMTParserWp.mly"
  ( None, args @ (snd m))
# 571 "parser/SMTParserWp.ml"
         in
...
# 28 "parser/SMTParserWp.mly"
      (Formula.status option * (string * string) list list)
# 589 "parser/SMTParserWp.ml"
        )) : (
# 28 "parser/SMTParserWp.mly"
      (Formula.status option * (string * string) list list)
# 593 "parser/SMTParserWp.ml"
        )) = _v in
...
# 28 "parser/SMTParserWp.mly"
      (Formula.status option * (string * string) list list)
# 714 "parser/SMTParserWp.ml"
    ) = 
# 40 "parser/SMTParserWp.mly"
        ( (None, []) )
# 718 "parser/SMTParserWp.ml"
     in
