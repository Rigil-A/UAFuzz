...
# 54 "parser/policy_parser.ml"
    ...
    | IFJUMP
    | IDENT of (
# 91 "parser/policy_parser.mly"
       (string)
# 61 "parser/policy_parser.ml"
  )
    | HEXA of (
# 92 "parser/policy_parser.mly"
       (string * int)
  ...
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    | LPAR ->
        ...
        | TAINTI ->
            ...
            ((let _1 = () in
            let _v : 'tv_taint = 
# 164 "parser/policy_parser.mly"
           ( Taint_types.TaintI )
# 411 "parser/policy_parser.ml"
             in
...
# 569 "parser/policy_parser.ml"
    ...
    | MenhirState143 ->
        ...
        | RPAR | TOACTION ->
            ...
            let _2 = () in
            let _v : 'tv_sigma_p = 
# 156 "parser/policy_parser.mly"
                        ( SigmaBinary(Policy_type.Or,_1,_3) )
# 597 "parser/policy_parser.ml"
             in
...
# 658 "parser/policy_parser.ml"
    ...
    | MenhirState137 ->
        ...
        | RPAR ->
            ...
            let _1 = () in
            let _v : 'tv_sigma_p = 
# 155 "parser/policy_parser.mly"
                           ( SigmaUnary(Policy_type.Not,_3) )
# 691 "parser/policy_parser.ml"
             in
...
# 146 "parser/policy_parser.mly"
             ( InstPattern(_1) )
# 752 "parser/policy_parser.ml"
     in
...
and _menhir_run49 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    ((let _1 = () in
    let _v : 'tv_bin_op = 
# 303 "parser/policy_parser.mly"
       ( Dba.Binary_op.Or )
# 836 "parser/policy_parser.ml"
     in
...
and _menhir_run53 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    ((let _1 = () in
    let _v : 'tv_bin_op = 
# 301 "parser/policy_parser.mly"
        ( Dba.Binary_op.ModU )
# 892 "parser/policy_parser.ml"
     in
...
and _menhir_run54 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    ((let _1 = () in
    let _v : 'tv_bin_op = 
# 302 "parser/policy_parser.mly"
        ( Dba.Binary_op.ModS )
# 906 "parser/policy_parser.ml"
     in
...
and _menhir_run60 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    ((let _1 = () in
    let _v : 'tv_bin_op = 
# 317 "parser/policy_parser.mly"
       ( Dba.Binary_op.LeqU )
# 990 "parser/policy_parser.ml"
     in
...
and _menhir_run67 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    ((let _1 = () in
    let _v : 'tv_bin_op = 
# 315 "parser/policy_parser.mly"
       ( Dba.Binary_op.Eq )
# 1074 "parser/policy_parser.ml"
     in
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState0 ->
        ...
        | EOF ->
            ...
            let _2 = () in
            let _v : (
# 108 "parser/policy_parser.mly"
      (Policy_type.policy)
# 1154 "parser/policy_parser.ml"
            ) = 
# 114 "parser/policy_parser.mly"
              ( _1 )
# 1158 "parser/policy_parser.ml"
             in
...
# 90 "parser/policy_parser.mly"
       (string)
# 1261 "parser/policy_parser.ml"
            )) : (
# 90 "parser/policy_parser.mly"
       (string)
# 1265 "parser/policy_parser.ml"
            )) = _v in
            ((let ((_menhir_stack, _menhir_s), _, (_2 : 'tv_expr)) = _menhir_stack in
            let _1 = () in
            let _v : 'tv_expr = 
# 275 "parser/policy_parser.mly"
                  (
    let size = int_of_string _3 in
    Dba.Expr.sext size _2
  )
# 1275 "parser/policy_parser.ml"
             in
...
# 90 "parser/policy_parser.mly"
       (string)
# 1447 "parser/policy_parser.ml"
            )) : (
# 90 "parser/policy_parser.mly"
       (string)
# 1451 "parser/policy_parser.ml"
            )) = _v in
            ((let ((_menhir_stack, _menhir_s), _, (_2 : 'tv_expr)) = _menhir_stack in
            let _1 = () in
            let _v : 'tv_expr = 
# 271 "parser/policy_parser.mly"
                  (
    let size = int_of_string _3 in
    Dba.Expr.uext size _2
  )
# 1461 "parser/policy_parser.ml"
             in
    ...
    | MenhirState106 | MenhirState36 ->
        ...
        | EXTS | EXTU | HEXA _ | IDENT _ | IFJUMP | INT _ | LBRACE | LPAR | NEXT | NOT | STORELOAD ->
            ...
            let _v : 'tv_cond = 
# 334 "parser/policy_parser.mly"
           ( e )
# 1571 "parser/policy_parser.ml"
             in
    ...
    | MenhirState79 ->
        ...
        | COMMA | DCOLON | ELSE | EXTS | EXTU | HEXA _ | IDENT _ | IFJUMP | INT _ | LBRACE | LPAR | NEXT | NOT | RBRACKET | RPAR | STORELOAD | SUBTERM ->
            ...
            let _1 = () in
            let _v : 'tv_expr = 
# 279 "parser/policy_parser.mly"
                               ( Dba.Expr.ite _2 _3 _5 )
# 1745 "parser/policy_parser.ml"
             in
...
# 90 "parser/policy_parser.mly"
       (string)
# 1795 "parser/policy_parser.ml"
                        ))) = Obj.magic _menhir_stack in
                        let (_v : (
# 90 "parser/policy_parser.mly"
       (string)
# 1800 "parser/policy_parser.ml"
                        )) = _v in
                        ((let _menhir_stack = (_menhir_stack, _v) in
                        let _menhir_env = _menhir_discard _menhir_env in
                        let _tok = _menhir_env._menhir_token in
...
# 90 "parser/policy_parser.mly"
       (string)
# 1811 "parser/policy_parser.ml"
                            ))) * (
# 90 "parser/policy_parser.mly"
       (string)
# 1815 "parser/policy_parser.ml"
                            )) = Obj.magic _menhir_stack in
                            ((let _menhir_env = _menhir_discard _menhir_env in
                            let (_menhir_env : _menhir_env) = _menhir_env in
...
# 90 "parser/policy_parser.mly"
       (string)
# 1822 "parser/policy_parser.ml"
                            ))) * (
# 90 "parser/policy_parser.mly"
       (string)
# 1826 "parser/policy_parser.ml"
                            )) = Obj.magic _menhir_stack in
                            ((let (((((_menhir_stack, _menhir_s), _, (_2 : 'tv_expr)), _), (_4 : (
# 90 "parser/policy_parser.mly"
       (string)
# 1831 "parser/policy_parser.ml"
                            ))), (_6 : (
# 90 "parser/policy_parser.mly"
       (string)
# 1835 "parser/policy_parser.ml"
                            ))) = _menhir_stack in
                            let _7 = () in
                            let _5 = () in
                            let _3 = () in
...
# 90 "parser/policy_parser.mly"
       (string)
# 1858 "parser/policy_parser.ml"
                            ))) * (
# 90 "parser/policy_parser.mly"
       (string)
# 1862 "parser/policy_parser.ml"
                            )) = Obj.magic _menhir_stack in
...
# 1884 "parser/policy_parser.ml"
    ...
    | MenhirState30 ->
        ...
        | RPAR ->
            ...
            let _1 = () in
            let _v : 'tv_expr = 
# 280 "parser/policy_parser.mly"
                   ( _2 )
# 2017 "parser/policy_parser.ml"
             in
...
# 2113 "parser/policy_parser.ml"
    ...
    | MenhirState29 ->
        ...
        let _1 = () in
        let _v : 'tv_expr = 
# 265 "parser/policy_parser.mly"
                            ( Dba.Expr.uminus _2 )
# 2138 "parser/policy_parser.ml"
         in
...
# 90 "parser/policy_parser.mly"
       (string)
# 2194 "parser/policy_parser.ml"
                    )) = Obj.magic _menhir_stack in
                    ((let ((((_menhir_stack, _menhir_s), _, (_3 : 'tv_expr)), _), (_5 : (
# 90 "parser/policy_parser.mly"
       (string)
# 2199 "parser/policy_parser.ml"
                    ))) = _menhir_stack in
                    let _6 = () in
                    let _4 = () in
                    let _2 = () in
...
# 2221 "parser/policy_parser.ml"
        ...
        | RBRACKET ->
            ...
            let _1 = () in
            let _v : 'tv_expr = 
# 261 "parser/policy_parser.mly"
                                     (
    Dba.Expr.load (Size.Byte.create 0) LittleEndian _3
  )
# 2293 "parser/policy_parser.ml"
             in
...
# 90 "parser/policy_parser.mly"
       (string)
# 2348 "parser/policy_parser.ml"
                    )) = Obj.magic _menhir_stack in
                    ((let (((_menhir_stack, _, (e : 'tv_expr)), _), (x00 : (
# 90 "parser/policy_parser.mly"
       (string)
# 2353 "parser/policy_parser.ml"
                    ))) = _menhir_stack in
                    let _5 = () in
                    let _100 = () in
                    let _2 = () in
...
# 157 "/home/khoile/.opam/4.05.0/lib/menhir/standard.mly"
    ( x )
# 2368 "parser/policy_parser.ml"
                        
                      in
                      
# 112 "/home/khoile/.opam/4.05.0/lib/menhir/standard.mly"
    ( Some x )
# 2374 "parser/policy_parser.ml"
                      
                    in
                    
# 227 "parser/policy_parser.mly"
  (
    let bytesize =
      match sz with
...
# 2479 "parser/policy_parser.ml"
    ...
    | MenhirState104 ->
        ...
        | DCOLON ->
            ...
            let _1 = () in
            let _v : 'tv_inst = 
# 204 "parser/policy_parser.mly"
              ( Dba.Instr.dynamic_jump _2 )
# 2562 "parser/policy_parser.ml"
             in
...
# 150 "parser/policy_parser.mly"
         ( ExpDba _1 )
# 3055 "parser/policy_parser.ml"
             in
    ...
    | MenhirState156 ->
        ...
        | DCOLON ->
            ...
            let _2 = () in
            let _v : 'tv_expression_p = 
# 151 "parser/policy_parser.mly"
                      ( ExpSubTerm(_1,_3) )
# 3130 "parser/policy_parser.ml"
             in
...
and _menhir_goto_rule : _menhir_env -> 'ttv_tail -> _menhir_state -> 'tv_rule -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | EOF ->
        ...
        let _v : 'tv_rules = 
# 118 "parser/policy_parser.mly"
         ( [_1] )
# 3247 "parser/policy_parser.ml"
         in
...
# 133 "parser/policy_parser.mly"
             ( LocSet(_1) )
# 3270 "parser/policy_parser.ml"
         in
...
# 90 "parser/policy_parser.mly"
       (string)
# 3573 "parser/policy_parser.ml"
            ))) = Obj.magic _menhir_stack in
            let (_v : (
# 90 "parser/policy_parser.mly"
       (string)
# 3578 "parser/policy_parser.ml"
            )) = _v in
            ((let _menhir_stack = (_menhir_stack, _v) in
            let _menhir_env = _menhir_discard _menhir_env in
            let _tok = _menhir_env._menhir_token in
...
# 90 "parser/policy_parser.mly"
       (string)
# 3613 "parser/policy_parser.ml"
                ))) = _menhir_stack in
                let _4 = () in
                let _2 = () in
                let _v : 'tv_expr = 
# 237 "parser/policy_parser.mly"
                        (
    let size = int_of_string _3 in
...
# 90 "parser/policy_parser.mly"
       (string)
# 3659 "parser/policy_parser.ml"
        )) = Obj.magic _menhir_stack in
        ((let (_menhir_stack, _menhir_s, (_1 : (
# 90 "parser/policy_parser.mly"
       (string)
# 3664 "parser/policy_parser.ml"
        ))) = _menhir_stack in
        let _v : 'tv_expr = 
# 243 "parser/policy_parser.mly"
        (
    let bigint = Bigint.big_int_of_string _1 in
    Dba.Expr.constant (Bitvector.create bigint 0)
  )
# 3672 "parser/policy_parser.ml"
         in
...
# 91 "parser/policy_parser.mly"
       (string)
# 3741 "parser/policy_parser.ml"
    )) = _v in
    ((let _v : 'tv_expr = 
# 253 "parser/policy_parser.mly"
          (
    let var = Parse_helpers.expr_of_name _1 in
    var
  )
# 3749 "parser/policy_parser.ml"
     in
...
# 92 "parser/policy_parser.mly"
       (string * int)
# 3770 "parser/policy_parser.ml"
    )) = _v in
    ((let _v : 'tv_expr = 
# 247 "parser/policy_parser.mly"
         (
    let s, size = _1 in
...
and _menhir_run40 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    ((let _1 = () in
    let _v : 'tv_cond = 
# 333 "parser/policy_parser.mly"
           ( Dba.Expr.zero )
# 3794 "parser/policy_parser.ml"
     in
...
and _menhir_reduce8 : _menhir_env -> 'ttv_tail * _menhir_state * 'tv_addr -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let (_menhir_stack, _menhir_s, (_1 : 'tv_addr)) = _menhir_stack in
    let _v : 'tv_addrlist = 
# 139 "parser/policy_parser.mly"
        ( [_1] )
# 3966 "parser/policy_parser.ml"
     in
...
# 91 "parser/policy_parser.mly"
       (string)
# 4023 "parser/policy_parser.ml"
                    ))) = Obj.magic _menhir_stack in
                    let (_v : (
# 90 "parser/policy_parser.mly"
       (string)
# 4028 "parser/policy_parser.ml"
                    )) = _v in
                    ((let _menhir_stack = (_menhir_stack, _v) in
                    let _menhir_env = _menhir_discard _menhir_env in
                    let _tok = _menhir_env._menhir_token in
...
# 90 "parser/policy_parser.mly"
       (string)
# 4057 "parser/policy_parser.ml"
                            ))) = Obj.magic _menhir_stack in
                            let (_v : (
# 90 "parser/policy_parser.mly"
       (string)
# 4062 "parser/policy_parser.ml"
                            )) = _v in
                            ((let _menhir_stack = (_menhir_stack, _v) in
                            let _menhir_env = _menhir_discard _menhir_env in
                            let _tok = _menhir_env._menhir_token in
...
# 90 "parser/policy_parser.mly"
       (string)
# 4109 "parser/policy_parser.ml"
                                ))) = _menhir_stack in
                                let _6 = () in
                                let _4 = () in
                                let _2 = () in
                                let _v : 'tv_lhs = 
# 220 "parser/policy_parser.mly"
  (
...
# 91 "parser/policy_parser.mly"
       (string)
# 4186 "parser/policy_parser.ml"
                )) = Obj.magic _menhir_stack in
                ((let (_menhir_stack, (v : (
# 91 "parser/policy_parser.mly"
       (string)
# 4191 "parser/policy_parser.ml"
                ))) = _menhir_stack in
                let _v : 'tv_lhs = 
# 218 "parser/policy_parser.mly"
            ( infer_variable_lhs v )
# 4196 "parser/policy_parser.ml"
                 in
...
and _menhir_run14 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    ((let _1 = () in
    let _v : 'tv_action = 
# 127 "parser/policy_parser.mly"
         ( KeepOrSymb )
# 4401 "parser/policy_parser.ml"
     in
...
and _menhir_run15 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    ((let _1 = () in
    let _v : 'tv_action = 
# 126 "parser/policy_parser.mly"
         ( Conc )
# 4415 "parser/policy_parser.ml"
     in
...
# 92 "parser/policy_parser.mly"
       (string * int)
# 4742 "parser/policy_parser.ml"
    )) = _v in
    ((let _v : 'tv_addr = 
# 142 "parser/policy_parser.mly"
         ( Int64.of_string (fst _1))
# 4747 "parser/policy_parser.ml"
     in
    let (_menhir_env : _menhir_env) = _menhir_env in
...
# 4799 "parser/policy_parser.ml"
    ...
    | MenhirState161 ->
        ...
        let _2 = () in
        let _v : 'tv_location_p = 
# 134 "parser/policy_parser.mly"
                          ( LocInterval(_1,_3) )
# 4848 "parser/policy_parser.ml"
         in
...
# 113 "parser/policy_parser.mly"
        ( [] )
# 4984 "parser/policy_parser.ml"
         in
